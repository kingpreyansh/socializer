...
int main() { 
    ...
    if (count != 3) {
        printf("Test #10 failed. Mustafa has an incorrect number of friends. Expected number of friends: 3, Received number of friends: %d\n", count);
    } 
    ...
    if (!(angela_and_brian1 == 1 && angela_and_man5 == 2)) {
        printf("angela and brian: %d, expected: 1\nangela and man5: %d, expected: 2\n", angela_and_brian1, angela_and_man5);
        return 1;
    }
    ...
    if (!(get_degrees_of_connection(g, v) == 5)) {
        printf("degree: %d, expected: 5\n", get_degrees_of_connection(g, v));
        return 1;
    }
    ...
    if (!(angela_and_brian11 == 1 && angela_and_man15 == 6)) {
        printf("angela and brian: %d, expected: 1\nangela and man5: %d, expected: 6\n", angela_and_brian11, angela_and_man15);
        return 1;
    }
